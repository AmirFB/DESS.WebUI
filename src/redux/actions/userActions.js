...
export const GET_GROUPS_REQUEST = "GET_USER_GROUPS_REQUEST";
export const GET_GROUPS_SUCCESS = "GET_USER_GROUPS_SUCCESS";
export const GET_GROUPS_ERROR = "GET_USER_GROUPS_ERROR";
